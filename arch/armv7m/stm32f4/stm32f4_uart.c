...
static const struct uart_params g_uart[] = {
    ...
    [0] = {STM32F4_REGBASE_USART1, STM32F4_REGOFF_RCC_APB2ENR, 4},
#endif
#ifdef STM32_HAVE_USART_2
    [1] = {STM32F4_REGBASE_USART2, STM32F4_REGOFF_RCC_APB1ENR, 17},
#endif
#ifdef STM32_HAVE_USART_3
    [2] = {0x40004800, STM32F4_REGOFF_RCC_APB1ENR, 18},
#endif
#ifdef STM32_HAVE_UART_4
    [3] = {0x40004C00, STM32F4_REGOFF_RCC_APB1ENR, 19},
#endif
#ifdef STM32_HAVE_UART_5
    [4] = {0x40005000, STM32F4_REGOFF_RCC_APB1ENR, 20},
#endif
#ifdef STM32_HAVE_USART_6
    [5] = {0x40011400, STM32F4_REGOFF_RCC_APB2ENR, 5},
#endif
...
{
    while(*s) stm32f4_uart_send(uartid, *s++);
}
