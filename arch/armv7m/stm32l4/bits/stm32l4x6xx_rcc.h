#ifndef _ARCH_ARMV7M_STM32L4_BITS_STM32L4X6XX_RCC_H_
#define _ARCH_ARMV7M_STM32L4_BITS_STM32L4X6XX_RCC_H_
...
/* Register CFGR */
#define RCC_CFGR_SWL_SHIFT         0
#define RCC_CFGR_SWL_MASK          (3<<RCC_CFGR_SWL_SHIFT)
...
#define RCC_PLLSAI2CFGR_PLLN_SHIFT 8
#define RCC_PLLSAI2CFGR_PLLN_MASK  (0x7F<<RCC_PLLSAI2CFGR_PLLN_SHIFT)
#define RCC_PLLSAI2CFGR_PLLPEN     (1<<16)
#define RCC_PLLSAI2CFGR_PLLP       (1<<17)
#define RCC_PLLSAI2CFGR_PLLREN     (1<<24)
#define RCC_PLLSAI2CFGR_PLLR_SHIFT 25
#define RCC_PLLSAI2CFGR_PLLR_MASK  (3<<RCC_PLLSAI2CFGR_PLLR_SHIFT)
