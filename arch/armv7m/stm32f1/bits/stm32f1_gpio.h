...
#define GPIO_MODE_MASK     (0x03 << 0)
#define GPIO_MODE_INPUT    (0x00 << 0)
#define GPIO_MODE_OUT10MHZ (0x01 << 0)
#define GPIO_MODE_OUT2MHZ  (0x02 << 0)
#define GPIO_MODE_OUT50MHZ (0x03 << 0)

#define GPIO_CNF_MASK      (0x03 << 2)
#define GPIO_CNF_ANALOG    (0x00 << 2)
#define GPIO_CNF_INFLOAT   (0x01 << 2)
#define GPIO_CNF_INPULL    (0x02 << 2)
#define GPIO_CNF_ALT       (0x02 << 2) /* 0x00 is GP */
#define GPIO_CNF_OD        (0x01 << 2) /* 0x00 is PP */
